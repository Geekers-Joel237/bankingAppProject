    ...
    <div class="container ">
        <div class="d-sm-flex align-items-center justify-content-between">
            <div >
                ...
                <p class="lead my-4">
                    We are focused on providing you with 
                    the best financial
    ...
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card bg-light">
                    <div class="card-body text-center">
                        <img src="https://randomuser.me/api/portraits/men/12.jpg" alt="" class="rounded-circle mb-3">
                        <h3 class="card-title mb-3">
                            Steve Smith
                        </h3>
                        <P class="card-text">
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card bg-light">
                    <div class="card-body text-center">
                        <img src="https://randomuser.me/api/portraits/women/12.jpg" alt="" class="rounded-circle mb-3">
                        <h3 class="card-title mb-3">
                            Sara Smith
                        </h3>
                        <P class="card-text">
     ...
     <script>
      ...
      <script>
        let typed = new Typed(".auto-input",{
            strings:["Secure","Transparent","Free of charge","Easy"],
            typeSpeed:100,
            backSpeed:100,
            loop:true
        })   
